...
const saveKey = 'rc-course-alert.saved'
const postKey = 'rc-course-alert.posts'
const alerts = [
  {
    "id": "rc-course-alert-1",
    "title": "営業 alert seed 1",
    "area": "名古屋",
    "category": "営業",
    "score": 95,
    "summary": "コース営業、大会、路面状況、パーツ入荷を通知し、施設送客とパーツECへつなげる。 営業の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "rc-course-alert-2",
    "title": "大会 alert seed 2",
    "area": "東京",
    "category": "大会",
    "score": 92,
    "summary": "コース営業、大会、路面状況、パーツ入荷を通知し、施設送客とパーツECへつなげる。 大会の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "rc-course-alert-3",
    "title": "路面 alert seed 3",
    "area": "大阪",
    "category": "路面",
    "score": 89,
    "summary": "コース営業、大会、路面状況、パーツ入荷を通知し、施設送客とパーツECへつなげる。 路面の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "rc-course-alert-4",
    "title": "パーツ alert seed 4",
    "area": "静岡",
    "category": "パーツ",
    "score": 86,
    "summary": "コース営業、大会、路面状況、パーツ入荷を通知し、施設送客とパーツECへつなげる。 パーツの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">ラジコン・ミニ四駆コース営業/大会通知</p>
          <h1>RC Course Alert</h1>
          <p className="lead">コース営業、大会、路面状況、パーツ入荷を通知し、施設送客とパーツECへつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>rccoursealert.jp / rc-course-alert</span>
